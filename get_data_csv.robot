...
Library    XML
Variables    /Users/pxzyia/Downloads/python/data.yaml   
...
*** Test Cases ***
Get Csv testing
    ${CSV_FILE}    Set Variable    /Users/pxzyia/Downloads/python/test_robot_csv.csv
    ...
    # Log To Console    ${DATA_CSV}
     ...
     Input Fname    ${row}[Fname]
     Input Lname    ${row}[Lname]
     Input Code    ${row}[Code]
     Click Continue
